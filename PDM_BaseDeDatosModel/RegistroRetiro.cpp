#include "RegistroRetiro.h"

using namespace PDM_BaseDeDatosModel;
using namespace System;

RegistroRetiro::RegistroRetiro(int codigo, String^ fecha, float cantMalta, float cantLupulo, float cantLevadura, int cantChapas, int cantBotellasVacias, Encargado^ objEncargado) {
	this->codigo = codigo;
	this->fecha = fecha;
